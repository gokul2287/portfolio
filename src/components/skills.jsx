				...
				<div className="colorlib-narrow-content">
					...
					<div className="row">
						<div className="col-md-12 animate-box" data-animate-effect="fadeInLeft">
							<p>Experienced Frontend Specialist with a demonstrated history of working with front-end frameworks like Angular, React, etc. Skilled in Javascript, HTML, CSS. Focusing to solve real world business problem with Technology.</p>
						</div>
